    ...
    <header>
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#">Mis Pedidos</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="bodyModificar">
                <h1>¿Esta seguro de cancelar el pedido?</h1>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-primary" id="btnCancelarPedido">Cancelar Pedido</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="js/misPedidos.js"></script>
