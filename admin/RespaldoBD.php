           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
                        <a class="active-menu inline-block" href="#"><img src="assets/img/ffffff-data-configuration-48.png" class="img-responsive inline-block" alt="Respaldar o Restaurar Base de datos"> Respaldo BD </a>
                    </li>	
                    <li  >
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">    
                        ...
                        <a class="btn btn-default" href="Respaldo/manual.php" ><img src="assets/img/ffa500-add-database-128.png" alt="" class="img-responsive">Generar respaldo Manual</a>                
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <a href="Respaldo/automatico.php" class="btn btn-default"><img src="assets/img/ffa500-add-database-128.png" alt="" class="img-responsive">Generar respaldo Automatico</a>            
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <a href="Respaldo/restaurar.php" class="btn btn-default"><img src="assets/img/ffa500-data-backup-128.png" alt="" class="img-responsive">Restaurar Base de Datos</a>
                        </div>
                    </div>
