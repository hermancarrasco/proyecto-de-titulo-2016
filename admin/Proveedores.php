        ...
        <nav class="navbar-default navbar-side" id="nav-lipigas" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li  >
                        <a class="active-menu" class="inline-block" href="Proveedores.php"><i class="fa fa-archive fa-3x"></i>Compra</a>
                    </li>               
                    <li  >
                ...
                <div class="col-xs-12 ">
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#facturas" aria-controls="facturas" role="tab" data-toggle="tab">Mostrar Facturas</a>
                            </li>
                        </ul>
