...
font-size: 16px;"> <!-- Last access : 30 May 2014 &nbsp;-->Ultimo acceso :  <?php 
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="GestionarVendedor.php"><i class="fa fa-map-marker fa-3x"></i> Gestionar Vendedores</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-xs-12 ">
                        <div class="well" id="contVendedores">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Asignación de Zona</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="btnAsignarZona">Asignar Zona</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="assets/js/toastr.js"></script>
      <!-- CUSTOM SCRIPTS -->
    <script src="js/GestionarVendedor.js"></script>
