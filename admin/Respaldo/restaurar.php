...
<body>
	<div id="wrapper">
		...
		<nav class="navbar-default navbar-side" id="nav-lipigas" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li  >
						<a class="active-menu inline-block" href="../RespaldoBD.php"><img src="../assets/img/ffffff-data-configuration-48.png" class="img-responsive inline-block" alt="Respaldar o Restaurar Base de datos"> Respaldo BD </a>
					</li>	
                    <li  >
        ...
        <div id="page-wrapper" >
        	<div id="page-inner">
        		...
        		<div class="row">
                <div class="alert alert-success text-center input-lg" id="mensajeRestauracionManual">
    ...
    <strong>Title!</strong> Alert body ...
        			...
        			<div class="col-xs-12 text-center">
        				...
        				if (strtoupper(substr(PHP_OS, 0,3))==='WIN') {
        					...
        					$dir="/Users/herman/Desktop/respaldo";
        				}    
    ...
    <thead>
      <tr>
         ...
         <th class="text-center">Restauración</th>
     </tr>
 </thead>
 <tbody>';
  foreach ($entradas as $archivo => $timestamp) { 
     ...
     <tr>
        ...
        <td>'.$archivo.'</td>
        <td><button type="button" value="'.$archivo.'" name="btnreg" class="btn btn-default btnreg">Restaurar </button></td>
    </tr>
    ';
