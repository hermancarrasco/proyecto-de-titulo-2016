            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <p>Para generar un respaldo de forma manual presione en el boton de Generar Reporte Manual</p>
                        <button class="btn btn-default btn-lg" id="btnGenerarRespaldoManual"><img src="../assets/img/ffa500-add-database-128.png" alt="">Generar Respaldo Manual</button>
                    </div>
