...
<head>
  ...
  <!-- MORRIS CHART STYLES-->
  <link href="assets/js/morris.js-0.5.1/morris.css" rel="stylesheet" />
  <!-- CUSTOM STYLES-->
        ...
        <nav class="navbar-default navbar-side" id="nav-lipigas" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li  >
                        <a class="active-menu" href="estadisticas.php"><i class="fa fa-bar-chart-o fa-3x"></i> Estadisticas</a>
                    </li>                    	
                    <li>
    ...
    <div role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active">
                <a href="#home" aria-controls="home" role="tab" data-toggle="tab">Grafico de Compras</a>
            </li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home">
                <!-- incio row de los 4 graficos de precios de gas-->
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Compra Gas 5Kg
                        </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Compra Gas 11Kg
                        </div>
                        <div class="panel-body">
                            <div id="chart11kg"></div>
                        </div>
                    </div>            
                </div>

            </div><!-- cierre row de los primeros 2 graficos-->
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Compra Gas 15Kg
                        </div>
                        <div class="panel-body">
                            <div id="chart15kg"></div>
                        </div>
                    </div>            
                </div> 
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Compra Gas 45Kg
                        </div>
                        <div class="panel-body">
                            <div id="chart45kg"></div>
                        </div>
                    </div>            
                </div>

            </div><!-- cierre row de los 2 ultimos graficos -->
            </div>
            <hr>  
            <p>Graficos de ventas</p>
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Venta Gas 5Kg
                        </div>
                        <div class="panel-body">
                            <div id="chartVenta5kg"></div>
                        </div>
                    </div>            
                </div> 
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Venta Gas 11Kg
                        </div>
                        <div class="panel-body">
                            <div id="chartVenta11kg"></div>
                        </div>
                    </div>            
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Venta Gas 15Kg
                        </div>
                        <div class="panel-body">
                            <div id="chartVenta15kg"></div>
                        </div>
                    </div>            
                </div> 
                <div class="col-md-6 col-sm-12 col-xs-12">                     
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            Grafico Venta Gas 45Kg
                        </div>
                        <div class="panel-body">
                            <div id="chartVenta45kg"></div>
                        </div>
                    </div>            
                </div>

            </div><!-- cierre row de los 2 ultimos graficos de ventas -->
